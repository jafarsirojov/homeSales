...
func ExampleSearchByMaxPrice() {
	...
	fmt.Println(result)
	// Output: [{1 1 комнатная квартира, 99 кв.м. 9/25 эт. 600000 Душанбе р.Сино, Борбад 33 10 1578232244 Вася} {2 2 комнатная квартира, 110 кв.м. 3/25 эт. 650000 Душанбе р.Фирдовси, Дусти 15 13 1578233112 Петя} {3 1 комнатная квартира, 50 кв.м. 3/9 эт. 200000 Худжанд р.Спитамен, Кахрамон 1 250 1578235602 Олег} {4 4 комнатная квартира, 120 кв.м. 3/4 эт. 280000 Куляб р., Дусти 1 180 1578235694 Игор}]
}
